...
import VideoPlayer from "./accessories/VideoPlayer";
            ...
            <div>
                <div className="flex justify-start relative max-w-xl my-2 mb-2">
                    ...
                    {message?.attachment && message?.attachment.type === "video" && (
                        <VideoPlayer src={message?.attachment?.filename} className="w-2/4 h-full" />
                    )}

                    {message?.attachment && message?.attachment.type === "audio" && (
                        <VoicePlayer src={message?.attachment?.filename} />
                    )}
                    {message?.sharedPost && (
