...
function Messages({
    ...
    function randomID(len) {
        ...
        const chars = "12345qwertyuiopasdfgh67890jklmnbvcxzMNBVCZXASDQWERTYHGFUIOLKJL",
            maxPos = chars.length;
        len = len || 5;
        for (let i = 0; i < len; i++) {
    ...
    //clicking outside retracts emoji popup
    useEffect(() => {
        ...
        <div className="relative flex flex-col flex-1">
            <div className="z-20 flex flex-grow-0 flex-shrink-0 w-full pr-3 bg-white border-b">
                <div className="w-12 h-12 mx-4 my-2 bg-blue-500 bg-center bg-no-repeat bg-cover rounded-full cursor-pointer">
                    {friend && <img className="rounded-full object-cover w-full h-full" src={friend?.profileImg} alt="" />}
                </div>
