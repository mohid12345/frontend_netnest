                ...
                <div className=" h-full px-3 py-4 overflow-y-auto bg-white dark:bg-black">
                    <div className="flex justify-center ">
                        <div className="logo-container max-w-64 h-auto overflow-hidden">
                            <img
                                className="logo-img transition-transform duration-300 ease-in-out transform hover:scale-110 w-64 flex"
                                src={logoImg}
                                alt=""
                            />
                        </div>
                    ...
                    <ul className="space-y-0 font-medium">
                        ...
                        >
                            <li>
                                <a className="flex items-center p-2 pb-3 text-gray-900 rounded-lg cursor-pointer dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    <svg
                                        className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                        aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      `}
                            >
                                ...
                                {notifBadge > 0 && (
                                    <span className="bg-blue-100 rounded-3xl text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 dark:bg-gray-700 dark:text-blue-400 border border-blue-400">
                                        {notifBadge}
                                    </span>
                                )}
                            </Link>
                    ...
                    <ul className="pt-4 mt-4 space-y-0 font-medium border-t border-gray-200 dark:border-gray-700">
                        ...
                        <li>
                            <Link
                                ...
                                onClick={handleClose}
                                className={`flex items-center p-2 pb-3 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group cursor-pointer
                    ${location.pathname === "/more" ? "bg-gray-100 dark:bg-gray-700 " : "text-gray-800"}
                    `}
                            >
                                <svg
                                    className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white
                      ${location.pathname === "/more" ? "text-gray-900" : "text-gray-500"}
                      `}
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
