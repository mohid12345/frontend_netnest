...
function ViewProfilePost({
    ...
    const ReplyCommentHandleSubmit = (values, { resetForm }) => {
        try {
            ...
            replyComment(commentData).then((response) => {
                const data = response.data;
                if (response.status === 200) {
                    const commentData = data.comments;
                    setComments(commentData);
                        ...
                        <div className="w-full lg:w-7/12 mr-2">
                            ...
                            <div className="w-full lg:px-2 lg:p-0 mb-2 h-max rounded-md border-none shadow-md bg-white border">
                                <div>
                                                ...
                                                {isDropdownOpen && (
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            className="w-full px-4 py-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300 hover:text-blue-600 rounded-md"
                                                        >
                                                            Edit
                                                        </button>
                                                        <button
                                                            onClick={() => handleDeletePost(post._id, userId)}
                                                            className="w-full px-4 py-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300 hover:text-red-600 rounded-md"
                                                        >
                                                            Delete
                                                        </button>
                                    ...
                                    {reportModal && (
                                        <ReportModal closeModal={handleReportModal} postId={post._id} userId={userId} />
                                    )}
                                    {
                                        <ConfirmationModal
                                            isOpen={isModalOpen}
                                    ...
                                    {isCommentsEnabled && (
                                        <div>
                                            {comments.length === 0 ? (
                                                <p
                                                    tabIndex="0"
                                                    className="flex justify-center focus:outline-none text-sm flex-shrink-0 leading-normal px-3 py-16 text-gray-500"
                                                >
                                                    Empty Comments :(
                                                </p>
                                            ) : (
                                    ...
                                    <div className="flex">
                                        ...
                                        {isLikesEnabled && (
                                            <span
                                                ...
                                                className="font-semibold cursor-pointer ml-2 py-0"
                                            >
                                                {likeCount} likes
                                            </span>
                                        )}
                                        {commentsCount > 0 && isCommentsEnabled && (
