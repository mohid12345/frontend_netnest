                    ...
                    <div id="controls-carousel" className="relative w-full bg-gray-200 rounded-md ">
                        ...
                        {imageUrlArray.length > 1 ? (
                            <div>
                                ...
                                <div className="absolute top-0 start-0 p-2 m-2 bg-slate-500/50 rounded-lg">
                                    <div className="text-black">{`${currentIndex + 1}/${imageUrlArray.length}`}</div>
                                </div>
                            </div>
                        ) : null}
                    </div>
                ...
                <div className="text-black block pb-2 ">
                    ...
                    <p className="text-sm break-words">
                        ...
                        {post.description.length > 150 && (
                            <span onClick={toggleDescription} className="cursor-pointer text-blue-500">
