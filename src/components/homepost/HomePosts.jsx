...
function HomePosts({ post, fetchPosts }) {
  ...
  useEffect(() => {
    setIsLikedByUser(
      likedUsers.some((likedUser) => likedUser._id === user._id)
    );
  }, [likedUsers, user._id]);
      ...
      <div>
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <div className=" mb-1">
              <p className="text-black lg:ml-4 ml-2 font-medium lg:text-xl dark:text-white">
                {userName}
              </p>
              <p className="text-black lg:ml-4 ml-2 font-normal lg:text-sm dark:text-white">
                {postDate}
              </p>
            </div>
          </div>
        ...
        >
          <div
            ...
            className="relative w-full bg-gray-200 rounded-md "
          >
            {/* //post image */}
            ...
            {isLikesEnabled && (
              <div className="flex">
                <span
                  ...
                  className="font-semibold cursor-pointer ml-2 py-0 text-gray-700 dark:text-white hover:text-black"
                >
                  {likeCount} likes
                </span>
                {commentsCount > 0 && (
