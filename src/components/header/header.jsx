...
function Header() {
  return (
    <div className='h-28 w-full flex items-center justify-start border-b-2 p-0 dark:bg-slate-700 dark:text-white'>
          ...
          <li className="inline-flex items-center gap-4">
            ...
            <div className='flex flex-col justify-center items-center'>
              <div className="flex items-center justify-center bg-gray-200 rounded-full h-14 w-14">
                <span className="text-center font-semibold text-xs p-2 dark:text-black ">Add stories</span>
              </div>
              <div className='flex items-center justify-center mt-1'>
                <p className=' text-xs font-normal'>ajzal_muhammed</p>
              </div>
            </div>
            {/* <div className='flex flex-col justify-center items-center'>
              <div className="flex items-center justify-center bg-gray-200 rounded-full h-14 w-14">
